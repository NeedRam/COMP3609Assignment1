...
public class Alien extends Thread {
   ...
   private int startY;		// regenerated alien drawn at this y coordinate
   ...
   public Alien (JPanel p, int xPos, int yPos, Bat bat) {
      ...
      alienImage = ImageManager.loadImage("Alien2.png");
   }
...
*/
   ...
   public void move() {
	  ...
	  setLocation();
	 // write code to speed up alien when it is re-generated at top
      }
   }
   ...
   public void run () {
      ...
      try {
	    ...
	    move ();
            draw();
            sleep (100);	// increase value of sleep time to slow down Alien
         }
      }
